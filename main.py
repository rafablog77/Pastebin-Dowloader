...
root.title('Pastebin Downloader')
...
label1 = tk.Label(root, text='Paste Key:', bg='#F5F5F5', font=('arial', 12, 'normal'))
...
c = tk.Button(root,text='download',bg='#F5F5F5',font=('arial',12,'normal'),command=down)
c.place(x=157, y=96)
